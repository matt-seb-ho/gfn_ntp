...
def main():
    RANDOM_TRAIN_DATA_PATH = repo_root() / "data/leandojo_benchmark_4/random/train.json"
    # NOVELP_TRAIN_DATA_PATH = repo_root() / "data/leandojo_benchmark_4/novel_premises/train.json"
    # sfttif: SFTTrainer Instruction Format
    OUTPUT_PATH = repo_root() / "data/sfttif_random_train.json"
